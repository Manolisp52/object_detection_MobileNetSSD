...
def obejct_det():
	...
	if int(width)<int(height): img = image.resize((400, 530), Image.ANTIALIAS)
	else: img = image.resize((750, 530), Image.ANTIALIAS)
...
root.geometry("{}x{}+{}+{}".format(window_width, window_height, x_cordinate-30, y_cordinate-30))
